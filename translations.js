const i18n = {
  es: {
    ...
    hero_title_2: " Un sistema con resultados comprobados.",
    ...
    svc2_title: "Consultoría + acompañamiento continuo",
    svc2_desc: "Una auditoría completa y un plan estratégico a 12 meses: tenés un departamento organizado viendo resultados inmediatos.",
    svc2_point: "Trabajo integrado a tu equipo actual, como un recurso extra: durante esos meses colaboramos todos juntos.",
    svc2_li1: "Diagnóstico estratégico (Marketing Frame)",
    svc2_li2: "Plan anual + KPIs operativos",
    ...
    why1: "<strong>De grandes empresas a startups.</strong> Aprendí a construir marketing sólido, y ahora armo áreas de marketing desde cero en cada startup, sin importar el tamaño del equipo.",
    ...
    pf_hero_sub: "Marketing estratégico, con la disciplina de grandes empresas y la agilidad de las startups. Construyo áreas de marketing de alto rendimiento, desde cero.",
    ...
    pf_numbers_heading: "Algunos números detrás del trabajo.",
    ...
    pf_p1_desc: "La disciplina de grandes marcas me acompaña en cada proyecto: una estrategia sólo es tan efectiva como su ejecución. Le pongo una mirada rigurosa a cada uno, asegurándome de que hasta la iniciativa más improvisada tenga una base sólida.",
    pf_p2_title: "Construir el motor, después alimentarlo",
    pf_p2_desc: "En una startup, la marca y el motor de demanda se arman juntos, es el mismo trabajo. Antes de invertir en pauta, dejo el CRM, la analítica y la cadencia de contenido funcionando. Cada canal se prueba, se mide y se decide con data, no a ojo.",
    ...
    pf_career_heading: "Nueve años, de grandes empresas a startups.",
    pf_career_aside: "Disciplina aprendida en grandes marcas globales, aplicada a construir áreas de marketing desde cero en startups.",
    ...
    pf_final_sub: "Si estás armando tu equipo de marketing, o solo querés comparar ideas, me encantaría hablar.",
  ...
  en: {
    ...
    hero_title_em: "works.",
    hero_title_2: " A system with proven results.",
    ...
    svc2_desc: "A full audit and a 12-month strategic plan: you get an organized department seeing immediate results.",
    svc2_point: "Embedded with your existing team, as an extra resource: we work side by side during those months.",
    svc2_li1: "Strategic diagnosis (Marketing Frame)",
    svc2_li2: "Annual plan + operating KPIs",
    ...
    why_role: "FRACTIONAL MARKETING LEADERSHIP · MARKETING STRATEGIST",
    why1: "<strong>From big companies to startups.</strong> I learned to build solid marketing, and now I build marketing departments from scratch at every startup, no matter the team size.",
    ...
    pf_hero_tag: "PORTFOLIO · MARKETING STRATEGIST · 2026",
    pf_hero_sub: "Strategic marketing, with the discipline of big companies and the agility of startups. I build high-performing marketing departments, from scratch.",
    ...
    pf_numbers_heading: "Some numbers behind the work.",
    pf_stat1_where: "AB InBev",
    ...
    pf_p1_desc: "The discipline of big brands stays with me on every project: a strategy is only as effective as its execution. I bring a rigorous eye to each one, making sure even the scrappiest initiative is built on a solid foundation.",
    pf_p2_title: "Build the engine, then fuel it",
    pf_p2_desc: "At a startup, brand and demand engine get built together, it's the same job. Before spending on paid, I get the CRM, analytics, and content cadence up and running. Every channel gets tested, measured, and decided by the data, not by gut feel.",
    ...
    pf_career_heading: "Nine years, from big companies to startups.",
    pf_career_aside: "Discipline learned at global brands, applied to building marketing departments from scratch at startups.",
    pf_tl1_co: "L'Oréal Paris",
    ...
    pf_final_sub: "If you're building your marketing team, or just want to compare notes, I'd love to talk.",
