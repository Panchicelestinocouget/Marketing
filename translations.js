const i18n = {
  es: {
    ...
    svc2_desc: "Proyecto de 90 días, alcance cerrado y costo fijo: auditoría completa, plan estratégico a 12 meses y acompañamiento activo mientras tu equipo lo ejecuta.",
    ...
    svc3_ideal: "Ideal para: Startups que ya tienen el sistema armado (por ejemplo, después de Servicio 01) y quieren seguir con liderazgo activo, a un costo predecible.",
  ...
  en: {
    ...
    hero_k4: "INVESTMENT",    hero_v4: "Fixed cost, locked in from day 1",
    ...
    svc2_desc: "A 90-day project, closed scope and fixed cost: a full audit, a 12-month strategic plan, and active support while your team executes it.",
    ...
    svc3_ideal: "Ideal for: Startups that already have the system in place (for example, after Service 01) and want to continue with active leadership, at a predictable cost.",
